...
<a style="display:none"href="https://buero-paris.com/">https://buero-paris.com/</a>
<?php
//session_start();
...
<head>
  ...
  <meta charset="UTF-8">
  	<title>Aplikasi Sistem Informasi Manajemen Aset</title>
...
<body>
	<header id="header">
		<hgroup>
			<h1 class="site_title">
				<div class="logo_aset"><a href="index.php"><img src="images/logo-aset2.png" alt=""></a></div>
			</h1>
			<h2 class="section_title"><?php echo $identitas_sekolah[1]; ?></h2>
			<h6 class="alamat">Alamat : <?php echo $identitas_sekolah[2]; ?></h6>
	  </hgroup>
	</header>
	<section id="side_bar">
  ...
  <div class="login">
    ...
    <br />
    <div id="kiri"><img src="images/chrome.png"></div>
	<div id="kanan">Gunakan browser Google Chrome untuk menjalankan aplikasi ini.</div>
 </div>
